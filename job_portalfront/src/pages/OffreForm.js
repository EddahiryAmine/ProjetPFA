...
const OffreForm = () => {
    ...
    if (id) {
      const fetchOffre = async () => {
        try {
          ...
          showNotification('error', 'Erreur lors de la récupération de l\'offre');
        }
      };
      fetchOffre();
    }
  ...
  useEffect(() => {
    const fetchPreferences = async () => {
      try {
        const response = await axios.get('http://localhost:8000/api/employeur/preferences', {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
        });
        ...
        showNotification('error', 'Erreur lors du chargement des préférences');
      }
    };
  ...
  const handlePrefChange = e => {
    ...
    const selected = [...offre.preferences];
    
    if (selected.includes(id)) {
      setOffre({ ...offre, preferences: selected.filter(p => p !== id) });
    } else if (selected.length < 3) {
      setOffre({ ...offre, preferences: [...selected, id] });
    }
  };
  ...
  const showNotification = (type, message) => {
    ...
    notification.style = notificationStyles[type];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        await axios.put(`http://localhost:8000/api/offres/${id}`, offre, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
            Accept: 'application/json',
          },
        ...
        await axios.post('http://localhost:8000/api/offres', offre, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
            Accept: 'application/json',
          },
        });
        showNotification('success', 'Offre créée avec succès !');
      }
      setTimeout(() => {
      ...
      <div style={styles.content}>
        <div style={styles.offreContainer}>
          <h2 style={styles.offreTitle}>
            {id ? "Modifier l'offre" : "Créer une nouvelle offre"}
          ...
          <form onSubmit={handleSubmit} style={styles.offreForm}>
            <div style={styles.formGroup}>
              ...
              <label 
                ...
                style={{
                  ...styles.formLabel,
                  ...(offre.titre ? styles.formLabelFocus : {})
                }}
              >
                Titre du poste
              </label>
            ...
            <div style={styles.formGroup}>
              ...
              <label 
                ...
                style={{
                  ...styles.formLabel,
                  ...(offre.description ? styles.formLabelFocus : {})
                }}
              >
            ...
            <div style={{
              ...
              <div style={{...styles.formGroup, flex: 1}}>
                ...
                <label 
                  ...
                  style={{
                    ...styles.formLabel,
                    ...(offre.salaire ? styles.formLabelFocus : {})
                  }}
                >
                  Salaire proposé
                </label>
              ...
              <div style={{...styles.formGroup, flex: 1}}>
                ...
                <label 
                  ...
                  style={{
                    ...styles.formLabel,
                    ...(offre.localisation ? styles.formLabelFocus : {})
                  }}
                >
                  Localisation
                </label>
                  ...
                  allPreferences.map(pref => (
                    <div key={pref.id} style={styles.preferenceItem}>
                      <input
                        ...
                        id={`pref-${pref.id}`}
                        value={pref.id}
                        checked={offre.preferences.includes(pref.id)}
                        onChange={handlePrefChange}
                        disabled={!offre.preferences.includes(pref.id) && offre.preferences.length >= 3}
                      ...
                      <label 
                        ...
                        style={{
                          ...
                          ...(!offre.preferences.includes(pref.id) && offre.preferences.length >= 3 ? styles.checkboxLabelDisabled : {})
                        }}
                      >
                        <span 
                          style={{
                            ...styles.checkboxCustom,
                            ...(offre.preferences.includes(pref.id) ? styles.checkboxCustomChecked : {}),
                          }}
                        >
                          {offre.preferences.includes(pref.id) && (
                            <span style={{
                              content: "''",
                              position: 'absolute',
                              top: '2px',
            ...
            <div style={styles.formSubmit}>
              ...
              >
                {isSubmitting ? (
                  ...
                  id ? "Modifier l'offre" : "Créer l'offre"
                )}
              </button>
            </div>
          </form>
